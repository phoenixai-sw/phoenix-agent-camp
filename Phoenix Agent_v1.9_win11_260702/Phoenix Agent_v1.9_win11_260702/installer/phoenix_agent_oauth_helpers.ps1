...
function Ensure-PhoenixWin11Base {
  ...
  Write-Host "Phoenix Agent v1.9 Win11 base tool check." -ForegroundColor Yellow
  ...
  Write-Host "OK: Phoenix Agent v1.9 Win11 base tool check complete" -ForegroundColor Green
}
...
function Invoke-PhoenixOpenAICodexImportRepair {
  ...
  $repair = Join-Path $PSScriptRoot "phoenix_v19_auth_order_repair.cjs"
